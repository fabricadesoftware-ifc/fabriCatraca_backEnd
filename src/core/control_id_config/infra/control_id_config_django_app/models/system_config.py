...
class SystemConfig(models.Model):
    ...
    url_reboot_enabled = models.BooleanField(default=False, help_text="Habilitar reinicialização via URL")
    ...
    catra_timeout = models.IntegerField(default=5000, help_text="Timeout da catraca em milissegundos")
